...
import { BackendStatusProvider, useBackendStatus } from "@/lib/backend-status";
...
function ConnectionPill() {
  ...
  if (mode === "checking") {
    return (
      <span
        className="hidden items-center gap-1.5 rounded-full border border-white/10 bg-white/6 px-2.5 py-1 text-[10.5px] font-medium uppercase tracking-wider text-white/65 md:inline-flex"
        title={`Checking backend at ${base}`}
      >
  ...
  if (mode === "live") {
    return (
      <span
        className="hidden items-center gap-1.5 rounded-full border border-[oklch(0.78_0.18_158/0.45)] bg-[oklch(0.78_0.18_158/0.18)] px-2.5 py-1 text-[10.5px] font-medium uppercase tracking-wider text-[oklch(0.92_0.13_158)] md:inline-flex"
  ...
  return (
    <span
      className="hidden items-center gap-1.5 rounded-full border border-[oklch(0.76_0.18_78/0.45)] bg-[oklch(0.76_0.18_78/0.16)] px-2.5 py-1 text-[10.5px] font-medium uppercase tracking-wider text-[oklch(0.93_0.14_78)] md:inline-flex"
      title={`Backend unreachable at ${base} — showing demo data`}
    >
      <span className="inline-block h-1.5 w-1.5 rounded-full bg-[oklch(0.82_0.18_78)]" />
      Demo
    </span>
  );
}
          ...
          <div className="relative mx-auto flex h-16 max-w-[1480px] items-center gap-4 px-4 md:px-6">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                ...
                className="hidden items-center gap-2 rounded-lg border border-white/10 bg-white/6 px-3 py-2 text-xs text-white/66 transition hover:bg-white/10 hover:text-white md:flex"
              >
